...
CREATE TABLE `vehicle` (
  ...
  CONSTRAINT `vehicle_ibfk_1` FOREIGN KEY (`operatorId`) REFERENCES `operator` (`operatorId`)
...
INSERT INTO `vehicle` VALUES ('V0001','O0001','SAB0001X','bus'),('V0002','O0002','SAB4444X','bus');
